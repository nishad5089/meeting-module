...
import {guest_settings, settings} from '../../constant/settings-type';
import {GuestAutocompleteComponent} from './guest-autocomplete.component';
import {Observable} from 'rxjs';
import {map} from 'rxjs/operators';

@Component({
  selector: 'app-guest-department',
  templateUrl: './autocomplete.component.html'
})

export class GuestDepartmentComponent extends GuestAutocompleteComponent<Settings> implements OnChanges {

  @Input() isRequired: boolean;

  constructor(protected service: SettingsService) {
    super(service, 'বিভাগ', 'বিভাগ বাছাই করুন', new Settings(guest_settings.department));
  }
